...
let value = 5000;
const value5000 = document
  .getElementById('value-5000')
  .addEventListener('click', () => {
    value = 5000;
    // console.log("click 10")
  });

const value10000 = document
  .getElementById('value-10000')
  .addEventListener('click', () => {
    value = 10000;
    // console.log("click 20")
  });
const value20000 = document
  .getElementById('value-20000')
  .addEventListener('click', () => {
    value = 20000;
